        ...
        $.each(result.data, function(key, value) {
          $("tbody#explorer").append(
            ...
            "</td><td><label class='badge  badge-info'>Transfer</label><td>" +
              value.data.sender.replace(foundationalWallet, foundationalWallet+" <label class='badge  badge-info'> Foundation</label>") +
              "</td><td>" +
    ...
    function(result) {
      ...
      $.each(result, function(key, value) {
        $("tbody#whitelist").append(
          "<tr>" +
            "<td>" +
            key.replace(foundationalWallet, foundationalWallet+' <label class="badge  badge-info"> Foundation</label>') +
